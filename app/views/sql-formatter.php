...
<title>SQL Formatter - Beautify SQL Online</title>
<meta name="description" content="Format and beautify SQL queries online. Free, fast, browser-based.">
...
<div class="tool-breadcrumb"><a href="/">&larr; All Tools</a> / SQL</div>
<h1 class="tool-title">SQL Formatter</h1>
<p class="tool-desc">Format and beautify SQL queries with proper indentation and syntax highlighting.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>SQL Input</span>
<div class="editor-actions">
<label class="btn btn-ghost btn-sm" title="Upload file">&#128194;<input type="file" accept=".sql" id="fileInput" style="display:none"></label>
...
<pre><code class="language-sql" id="outputCode"><span class="token comment">-- Formatted SQL will appear here --</span></code></pre>
</div>
