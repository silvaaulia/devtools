    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/sql-formatter" class="nav-link active">SQL</a>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">SQL Formatter</h1>
                    <p class="tool-page-desc">Format and beautify SQL queries</p>
                </div>
            </div>
        </div>
        ...
        <div class="editor">
            <div class="panel">
                ...
                <textarea id="input" placeholder="SELECT * FROM users WHERE id = 1"></textarea>
            </div>
            <div class="panel">
                <div class="panel-header">
                    <span>Output</span>
        ...
        function format() {
            try {
                const keywords = [
                    ...
                    'OUTER JOIN', 'ON', 'LIMIT', 'OFFSET', 'INSERT INTO', 'VALUES',
                    'UPDATE', 'SET', 'DELETE FROM', 'CREATE TABLE', 'ALTER TABLE',
                    'DROP TABLE', 'INSERT', 'CREATE', 'DROP', 'INDEX', 'AS',
                    'DISTINCT', 'COUNT', 'SUM', 'AVG', 'MAX', 'MIN', 'IN', 'LIKE',
                    'BETWEEN', 'IS NULL', 'IS NOT NULL', 'UNION', 'ALL', 'EXISTS',
                    'CASE', 'WHEN', 'THEN', 'ELSE', 'END', 'INNER', 'LEFT', 'RIGHT'
                ];

                let sql = input.value.trim();
                if (!sql) {
                    show('Please enter SQL code', 'error');
                    return;
                }
