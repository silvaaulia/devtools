...
<p class="tool-desc">Encode text for safe use inside URLs.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>URL Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="urlInput" placeholder="https://example.com/hello world"></textarea>
</div>

<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Encoded Output</span>
<div class="editor-actions">
...
<button class="btn btn-primary" id="formatBtn">&#128274; Encode URL</button>
</div>
