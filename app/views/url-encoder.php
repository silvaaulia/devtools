...
<title>URL Encoder - Encode URL Online</title>
<meta name="description" content="Encode URLs for safe transmission online.">
...
<h1 class="tool-title">URL Encoder</h1>
<p class="tool-desc">Encode URLs for safe transmission online.</p>
</div>
<div class="editor-container">
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>URL Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" data-tooltip="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="urlInput" placeholder="https://example.com?name=John Doe&city=New York"></textarea>
<div class="editor-header"><span class="kbd-hint"><span class="kbd">Ctrl</span>+<span class="kbd">Enter</span></span></div>
</div>
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot output"></span>Encoded Output</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="copyBtn" data-tooltip="Copy">&#128203;</button>
</div>
</div>
<pre><code id="outputCode"><!-- Encoded URL will appear here --></code></pre>
</div>
</div>
<div class="action-bar">
<button class="btn btn-primary" id="encodeBtn">&#128274; Encode URL</button>
<button class="btn btn-secondary" id="decodeBtn">&#128275; Decode URL</button>
