...
<h1 class="tool-title">CSV to XML Converter</h1>
<p class="tool-desc">Convert CSV data into XML format directly in your browser.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>CSV Input</span>
<div class="editor-actions">
<label class="btn btn-ghost btn-sm" title="Upload file">&#128194;<input type="file" accept=".csv" id="fileInput" style="display:none"></label>
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="csvInput" placeholder="name,age&#10;Silva,22&#10;Andi,25"></textarea>
</div>

<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>XML Output</span>
<div class="editor-actions">
...
<pre><code class="language-xml" id="outputCode"><span class="token comment">&lt;!-- XML output will appear here --&gt;</span></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="formatBtn">&#8644; Convert to XML</button>
</div>
