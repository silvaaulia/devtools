...
<meta name="description" content="Format and beautify XML online. Free, fast, browser-based.">
...
<div class="tool-breadcrumb"><a href="/">&larr; All Tools</a> / XML</div>
<h1 class="tool-title">XML Formatter</h1>
<p class="tool-desc">Format and beautify XML with proper indentation and structure.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>XML Input</span>
<div class="editor-actions">
<label class="btn btn-ghost btn-sm" title="Upload file">&#128194;<input type="file" accept=".xml" id="fileInput" style="display:none"></label>
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="xmlInput" placeholder="<users>&#10;  <user>&#10;    <name>John Doe</name>&#10;  </user>&#10;</users>"></textarea>
</div>
...
<pre><code class="language-xml" id="outputCode"><span class="token comment">&lt;!-- Formatted XML will appear here --&gt;</span></code></pre>
</div>
