    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/xml-formatter" class="nav-link active">XML</a>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">XML Formatter</h1>
                    <p class="tool-page-desc">Format and beautify XML documents with proper indentation</p>
                </div>
            </div>
        </div>
