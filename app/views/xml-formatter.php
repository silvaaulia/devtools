...
<title>XML Formatter - Beautify & Format XML Online</title>
<meta name="description" content="Format and beautify XML documents with proper indentation.">
...
<button class="nav-link" onclick="location.href='/'">All Tools</button>
<button class="nav-link" onclick="location.href='/json-formatter'">JSON</button>
<button class="nav-link active" onclick="location.href='/xml-formatter'">XML</button>
<button class="nav-link" onclick="location.href='/sql-formatter'">SQL</button>
<button class="nav-link" onclick="location.href='/regex-tester'">Regex</button>
</nav>
</header>
...
<p class="tool-desc">Format and beautify XML documents with proper indentation.</p>
</div>
...
<pre><code class="language-xml" id="outputCode"><!-- Formatted XML will appear here --></code></pre>
</div>
</div>
