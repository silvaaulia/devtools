...
<head>
    ...
    <title>Base64 Encoder - DevTools</title>
    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/base64-encoder" class="nav-link active">Base64 Encoder</a>
                <a href="/base64-decoder" class="nav-link">Base64 Decoder</a>
        ...
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    ...
                    <p class="tool-page-desc">Encode and decode Base64 strings</p>
                </div>
            </div>
        </div>
