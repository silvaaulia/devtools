...
<title>JSON to YAML Converter - Convert JSON to YAML Online</title>
<meta name="description" content="Convert JSON to YAML format online.">
...
<p class="tool-desc">Convert JSON to YAML format online.</p>
</div>
...
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot output"></span>YAML Output</span>
<div class="editor-actions">
...
<button class="btn btn-primary" id="convertBtn">&#128260; Convert to YAML</button>
