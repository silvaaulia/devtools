...
<meta property="og:title" content="JSON to YAML Converter - Convert JSON Online">
<meta property="og:description" content="Convert JSON data to YAML online with this free browser-based converter.">
...
Convert JSON data into YAML directly in your browser.
</p>
...
<textarea class="tool-textarea" id="input" placeholder='{
  "name": "Silva",
  "age": 22,
  "active": true
}'></textarea>
...
<nav class="tool-navigation"><div class="nav-prev"><a href="/yaml-to-json" class="nav-link">← YAML to JSON</a></div><a href="/" class="nav-home">All Tools</a><div class="nav-next"><a href="/base64-encoder" class="nav-link">Base64 Encoder →</a></div></nav>
