...
<meta name="description" content="Convert JSON to XML format online.">
...
<p class="tool-desc">Convert JSON to XML format online.</p>
</div>
...
<textarea class="editor-textarea" id="jsonInput" placeholder='{"name": "John", "age": 30}'></textarea>
...
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot output"></span>XML Output</span>
<div class="editor-actions">
...
<pre><code class="language-xml" id="outputCode"><!-- XML output will appear here --></code></pre>
</div>
</div>
<div class="action-bar">
<button class="btn btn-primary" id="convertBtn">&#128260; Convert to XML</button>
