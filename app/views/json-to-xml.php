...
<head>
    ...
    <title>JSON to XML Converter - DevTools</title>
...
<body>
    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/json-to-xml" class="nav-link active">JSON to XML</a>
                <a href="/xml-to-json" class="nav-link">XML to JSON</a>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">JSON to XML Converter</h1>
                    <p class="tool-page-desc">Convert JSON to XML format</p>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function jsonToXml(json, rootName = 'root') {
            ...
            xml += parseValue(json, rootName);
            return xml;
        }

        function parseValue(obj, name) {
            if (Array.isArray(obj)) {
                return obj.map(item => parseValue(item, name)).join('\n');
                ...
                const val = String(obj).replace(/[<>&'"]/g, c => ({'<':'&lt;','>':'&gt;','&':'&amp;',"'":"&apos;",'"':'&quot;'}[c]));
