...
<head>
    ...
    <title>XML Escape - DevTools</title>
    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/xml-escape" class="nav-link active">XML Escape</a>
            </div>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">XML Escape / Unescape</h1>
                    <p class="tool-page-desc">Escape or unescape XML special characters</p>
                </div>
            </div>
        </div>
        ...
        <div class="editor">
            <div class="panel">
                ...
                <textarea id="input" placeholder="<root>Hello & World</root>"></textarea>
            </div>
            <div class="panel">
                <div class="panel-header">
                    <span>Output</span>
        ...
        <div class="actions">
            <button class="btn btn-primary" id="escapeBtn">Escape</button>
