...
<p class="tool-desc">Decode Base64 data directly in your browser.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>Base64 Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="baseInput" placeholder="SGVsbG8gU2lsdmEh"></textarea>
</div>
...
<button class="btn btn-primary" id="formatBtn">&#128275; Decode Base64</button>
</div>
