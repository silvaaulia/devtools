...
<title>Base64 Decoder - Decode Base64 to Text Online</title>
<meta name="description" content="Decode Base64 to text format online.">
...
<h1 class="tool-title">Base64 Decoder</h1>
<p class="tool-desc">Decode Base64 to text format online.</p>
</div>
<div class="editor-container">
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Base64 Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" data-tooltip="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="base64Input" placeholder="SGVsbG8gV29ybGQ="></textarea>
<div class="editor-header"><span class="kbd-hint"><span class="kbd">Ctrl</span>+<span class="kbd">Enter</span></span></div>
</div>
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot output"></span>Decoded Output</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="copyBtn" data-tooltip="Copy">&#128203;</button>
</div>
</div>
<pre><code id="outputCode"><!-- Decoded text will appear here --></code></pre>
</div>
</div>
<div class="action-bar">
<button class="btn btn-primary" id="decodeBtn">&#128275; Decode Base64</button>
<button class="btn btn-secondary" id="encodeBtn">&#128274; Encode to Base64</button>
