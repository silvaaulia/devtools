...
<title>YAML to JSON Converter - Convert YAML to JSON Online</title>
<meta name="description" content="Convert YAML to JSON format online.">
...
<button class="nav-link" onclick="location.href='/yaml-to-json'">YAML</button>
...
<p class="tool-desc">Convert YAML to JSON format online.</p>
</div>
<div class="editor-container">
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>YAML Input</span>
<div class="editor-actions">
<label class="btn btn-ghost btn-sm" data-tooltip="Upload file">&#128194;<input type="file" accept=".yml,.yaml,.txt" id="fileInput" style="display:none"></label>
...
<textarea class="editor-textarea" id="yamlInput" placeholder="name: John&#10email: john@example.com&#10age: 30"></textarea>
