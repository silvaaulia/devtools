...
<p class="tool-desc">Decode URL encoded text directly in your browser.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>Encoded URL Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="urlInput" placeholder="Hello%20Silva%21"></textarea>
</div>

<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Decoded Output</span>
<div class="editor-actions">
...
<button class="btn btn-primary" id="formatBtn">&#128275; Decode URL</button>
</div>
