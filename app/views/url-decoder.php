...
<title>URL Decoder - Decode URL Online</title>
<meta name="description" content="Decode URL-encoded strings online.">
...
<h1 class="tool-title">URL Decoder</h1>
<p class="tool-desc">Decode URL-encoded strings online.</p>
</div>
<div class="editor-container">
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Encoded URL Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" data-tooltip="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="urlInput" placeholder="https%3A%2F%2Fexample.com%3Fname%3DJohn%20Doe"></textarea>
...
<pre><code id="outputCode"><!-- Decoded URL will appear here --></code></pre>
</div>
</div>
<div class="action-bar">
<button class="btn btn-primary" id="decodeBtn">&#128275; Decode URL</button>
<button class="btn btn-secondary" id="encodeBtn">&#128274; Encode URL</button>
