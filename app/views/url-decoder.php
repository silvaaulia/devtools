...
<head>
    ...
    <title>URL Decoder - DevTools</title>
    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/url-decoder" class="nav-link active">URL Decoder</a>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">URL Decoder</h1>
                    <p class="tool-page-desc">Decode URL encoded strings</p>
                </div>
            </div>
        </div>
        ...
        <div class="editor">
            <div class="panel">
                <div class="panel-header">
                    <span>URL Encoded Input</span>
                    <div class="panel-actions">
                        <button class="btn-icon" id="clearBtn" title="Clear">✕</button>
                    </div>
                </div>
                <textarea id="input" placeholder="https%3A%2F%2Fexample.com%3Fq%3Dhello"></textarea>
            </div>
            <div class="panel">
                <div class="panel-header">
                    <span>Output</span>
