...
<div class="tool-breadcrumb"><a href="/">&larr; All Tools</a> / Encoding</div>
...
<textarea class="editor-textarea" id="htmlInput" placeholder="<div>Hello & Welcome</div>"></textarea>
</div>

<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Output</span>
<div class="editor-actions">
...
<button class="btn btn-primary" id="formatBtn">&#128274; Escape HTML</button>
<button class="btn btn-secondary" id="minifyBtn">&#128275; Unescape</button>
</div>
