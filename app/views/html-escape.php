...
<title>HTML Escape & Unescape - Online HTML Tool</title>
<meta name="description" content="Escape and unescape HTML entities online with this free browser-based HTML tool.">
...
<h1 class="tool-title">HTML Escape / Unescape</h1>
<p class="tool-desc">Escape or unescape HTML special characters directly in your browser.</p>
</div>
...
<label class="btn btn-ghost btn-sm" data-tooltip="Upload file">&#128194;<input type="file" id="fileInput" accept=".txt,.html,.xml,.md" style="display:none"></label>
...
<textarea class="editor-textarea" id="htmlInput" placeholder="<div>Hello & World</div>"></textarea>
...
<pre><code id="outputCode"><!-- Escaped HTML will appear here --></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="escapeBtn">&#128274; Escape HTML</button>
...
<script src="/public/assets/js/html-escape.js"></script>
