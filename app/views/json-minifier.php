...
<meta name="description" content="Minify JSON and reduce unnecessary spaces directly in your browser.">
...
<p class="tool-desc">Minify JSON by removing unnecessary whitespace and reduce file size.</p>
</div>
...
<pre><code class="language-json" id="outputCode"><span class="token comment">&lt;!-- Minified JSON will appear here --&gt;</span></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="formatBtn">&#128195; Minify JSON</button>
</div>
