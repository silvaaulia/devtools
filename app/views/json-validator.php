...
<meta name="description" content="Validate JSON syntax and check for errors.">
...
<p class="tool-desc">Validate JSON syntax and check for errors.</p>
</div>
...
<button class="btn btn-primary" id="validateBtn">&#10004; Validate JSON</button>
