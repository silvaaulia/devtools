...
<meta name="description" content="Validate JSON and detect syntax errors online in your browser.">
...
<h1 class="tool-title">JSON Validator</h1>
<p class="tool-desc">Validate JSON and detect syntax errors directly in your browser.</p>
</div>
...
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Validation Result</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="copyBtn" title="Copy">&#128203;</button>
</div>
</div>
<pre><code class="language-json" id="outputCode"><span class="token comment">&lt;!-- Validation result will appear here --&gt;</span></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="formatBtn">&#10004; Validate JSON</button>
</div>
...
<script src="/public/assets/js/json-validator.js"></script>
