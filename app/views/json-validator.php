...
<head>
    ...
    <title>JSON Validator - DevTools</title>
    ...
    <header class="header">
        <div class="header-inner">
            ...
            <div class="header-nav">
                ...
                <a href="/json-validator" class="nav-link active">JSON Validator</a>
                <a href="/json-formatter" class="nav-link">JSON Formatter</a>
                <a href="/xml-validator" class="nav-link">XML Validator</a>
            </div>
    ...
    <main class="main">
        <div class="tool-header">
            <div class="tool-header-left">
                ...
                <div>
                    <h1 class="tool-page-title">JSON Validator</h1>
                    <p class="tool-page-desc">Validate JSON syntax and check for errors</p>
                </div>
            </div>
        </div>
