...
<div class="tool-breadcrumb"><a href="/">&larr; All Tools</a> / Utilities</div>
<h1 class="tool-title">Timestamp Converter</h1>
<p class="tool-desc">Convert Unix timestamps and dates quickly in your browser.</p>
</div>
...
<span class="editor-label"><span class="editor-label-dot input"></span>Timestamp Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="clearBtn" title="Clear">&#10005;</button>
</div>
</div>
<input type="text" id="timestampInput" placeholder="1788508800" style="width: 100%; padding: 12px; margin-bottom: 12px; border: 1px solid var(--border); border-radius: 8px; background: var(--surface); color: var(--text); font-family: inherit;">
<input type="datetime-local" id="dateInput" style="width: 100%; padding: 12px; margin-bottom: 12px; border: 1px solid var(--border); border-radius: 8px; background: var(--surface); color: var(--text); font-family: inherit;">
</div>

<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Converted Output</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="copyBtn" title="Copy">&#128203;</button>
</div>
</div>
<pre><code id="outputCode"><!-- Converted timestamp will appear here --></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="formatBtn">&#128197; Timestamp to Date</button>
<button class="btn btn-secondary" id="minifyBtn">&#128197; Date to Timestamp</button>
<button class="btn btn-ghost" id="downloadBtn">&#128336; Now</button>
</div>
