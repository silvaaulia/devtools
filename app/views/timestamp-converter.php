...
<title>Timestamp Converter - Convert Timestamps Online</title>
<meta name="description" content="Convert between timestamps and dates online.">
...
<button class="nav-link active" onclick="location.href='/timestamp-converter'">Time</button>
</div>
...
<div class="tool-breadcrumb"><a href="/">&larr; All Tools</a> / Testers</div>
<h1 class="tool-title">Timestamp Converter</h1>
<p class="tool-desc">Convert between timestamps and dates in different formats.</p>
</div>
<div class="editor-container">
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot"></span>Input</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="nowBtn" data-tooltip="Current time">&#128339;</button>
<button class="btn btn-ghost btn-sm" id="clearBtn" data-tooltip="Clear">&#10005;</button>
</div>
</div>
<textarea class="editor-textarea" id="input" placeholder="Enter timestamp or date string..."></textarea>
<div class="editor-header"><span class="kbd-hint"><span class="kbd">Ctrl</span>+<span class="kbd">Enter</span></span></div>
</div>
<div class="editor-panel">
<div class="editor-header">
<span class="editor-label"><span class="editor-label-dot output"></span>Results</span>
<div class="editor-actions">
<button class="btn btn-ghost btn-sm" id="copyBtn" data-tooltip="Copy">&#128203;</button>
</div>
</div>
<pre><code id="outputCode"><!-- Conversion results will appear here --></code></pre>
</div>
</div>
