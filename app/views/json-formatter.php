...
<label class="btn btn-ghost btn-sm" data-tooltip="Upload file">&#128194;<input type="file" accept=".json" id="fileInput" style="display:none"></label>
...
<pre><code class="language-json" id="outputCode"><!-- Formatted JSON will appear here --></code></pre>
</div>

</div>

<div class="action-bar">
<button class="btn btn-primary" id="formatBtn">&#9998; Format JSON</button>
