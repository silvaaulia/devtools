...
<title>XML to JSON Converter - Convert XML to JSON Online</title>
<meta name="description" content="Convert XML to JSON format online.">
...
<p class="tool-desc">Convert XML to JSON format online.</p>
</div>
...
<textarea class="editor-textarea" id="xmlInput" placeholder="<root><name>John</name></root>"></textarea>
