...
<h1 class="tool-title">XML to JSON Converter</h1>
<p class="tool-desc">Convert XML data into JSON format directly in your browser.</p>
</div>
...
<textarea class="editor-textarea" id="xmlInput" placeholder="<user><name>Silva</name><age>22</age></user>"></textarea>
</div>
